const translations = {
  de: {
    ...
    "boarding.title": "Wohin soll unsere Reise gehen?",
    "boarding.copy": "Wähle eine Station. Danach steigen wir gemeinsam in den InfoTrain.",
    "boarding.button": "Gemeinsam einsteigen",
  ...
  en: {
    ...
    "boarding.title": "Where should we travel?",
    "boarding.copy": "Choose a station. Then we’ll board the InfoTrain together.",
    "boarding.button": "Board together",
  ...
  fr: {
    ...
    "boarding.title": "Où allons-nous voyager ?",
    "boarding.copy": "Choisis une station. Ensuite, nous monterons ensemble dans l’InfoTrain.",
    "boarding.button": "Monter ensemble",
  ...
  es: {
    ...
    "boarding.title": "¿Adónde viajamos?",
    "boarding.copy": "Elige una estación. Después subiremos juntos al InfoTrain.",
    "boarding.button": "Subir juntos",
